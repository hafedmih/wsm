...
class Settings_model extends CI_Model {
 ...
 public function get_logo_dark($type = "") {
    ...
    if ($current_language == 'arabic') {
        if ($type == 'small') {
            return base_url('uploads/system/logo/logo-ar-sm.png');
        } else {
            return base_url('uploads/system/logo/logo-ar.png');
        }
    } 
    // Default to English or other languages
    else {
        if ($type == 'small') {
            return base_url('uploads/system/logo/logo-en-sm.png');
        } else {
            return base_url('uploads/system/logo/logo-en.png');
        }
    }
}
 ...
 public function get_logo_light($type = "") {
    ...
    if ($current_language == 'arabic') {
        // Returns Arabic Light Logos
        if ($type == 'small') {
            return base_url('uploads/system/logo/logo-light-sm.png');
        } else {
            return base_url('uploads/system/logo/logo-light-ar.png');
        }
    } else {
        // Returns English/Default Light Logos
        if ($type == 'small') {
            return base_url('uploads/system/logo/logo-light-sm.png');
        } else {
            return base_url('uploads/system/logo/logo-light-en.png');
        }
    }
}
