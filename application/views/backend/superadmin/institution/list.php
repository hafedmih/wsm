            ...
            <td>
                <div class="dropdown text-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- Edit Button (Points to institution/edit modal) -->
                        <a class="dropdown-item"
                           onclick="rightModal(
                           '<?= site_url("modal/popup/$entity/edit/".$user['id']) ?>',
                           '<?= get_phrase("update_institution") ?>')">
                           <i class="mdi mdi-pencil me-1"></i> <?= get_phrase('edit'); ?>
                        </a>
                        ...
                        <a class="dropdown-item text-danger"
                           ...
                           showAll)">
                           <i class="mdi mdi-delete me-1"></i> <?= get_phrase('delete'); ?>
                        </a>
                    </div>
                </div>
            </td>
