                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <div class="alert alert-light text-center" role="alert">
                            ...
                            <a href="javascript:void(0);" class="fw-bold" onclick="rightModal('<?php echo site_url('modal/popup/funding/create/'.$project['id']); ?>', '<?php echo get_phrase('add_funding'); ?>')"><?php echo get_phrase('add_the_first_record'); ?></a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
