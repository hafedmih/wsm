...
?>
<?php
$check_data = $this->db->get_where('currencies',['paypal_supported'=>1] );
                ...
                <div class="dropdown text-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item"
                           onclick="rightModal(
                           '<?= site_url("modal/popup/currency/edit/".$user['id']) ?>',
                           '<?= get_phrase("update_currency") ?>')">
                           <?= get_phrase('edit'); ?>
                        </a>

                        <a class="dropdown-item"
                           onclick="confirmModal(
                           '<?= route("currency/delete/".$user['id']) ?>',
                           showAll)">
                           <?= get_phrase('delete'); ?>
                        </a>
                    </div>
